...
const char* subthemes_aed[] = {
    ...
    "noções de tempo de execução",
    "vetores e arrays simples",
    ...
    "ordenação simples: selection sort",
    "ordenação simples: insertion sort",
    "uso de pilhas para organizar dados",
    "conceito de pilha e exemplos",
    "uso de filas para organizar dados",
    "conceito de fila e exemplos",
    "listas encadeadas simples",
    "inserção em listas encadeadas",
    "remoção em listas encadeadas",
    "conceito de ponteiros básico",
    ...
    "grafos: conceito e exemplos",
    "grafos: representações simples",
    "busca em grafos: DFS simples",
    "busca em grafos: BFS simples",
    "diferença entre grafo dirigido e não dirigido",
    "hashing simples",
    "funções de hash básicas",
    "tratamento de colisões simples",
    "algoritmos gulosos básicos",
    "introdução à programação dinâmica",
    "uso de tabelas para otimização",
    "algoritmos de força bruta",
    "algoritmos de divisão e conquista simples",
    "problemas clássicos de algoritmos",
    "uso de pseudocódigo para resolver problemas",
    "diferença entre algoritmos iterativos e recursivos",
    "análise de eficiência simples",
    ...
    "uso básico de árvores para organizar dados",
    "aplicações simples de pilhas e filas",
    "uso de filas de prioridade simples",
    "conceitos básicos de heap",
    "uso de pilhas para expressões matemáticas",
    "conversão de expressões infixa para pós-fixa",
    "verificação de parênteses balanceados",
    "exemplo simples de lista circular",
    "noções básicas de grafos ponderados",
    "conceito de caminho mínimo simples",
    "diferença entre busca linear e binária",
    "conceito de recursão de cauda",
    "estrutura de dados para mapas simples",
    "implementação básica de set",
    "diferença entre stack e queue",
    "uso de estruturas de dados em jogos simples",
    "implementação básica de fila circular",
    "noções básicas de árvore binária de busca",
    "introdução ao algoritmo de ordenação rápida (quick sort)",
    "introdução ao algoritmo merge sort",
    "diferenças entre algoritmos de ordenação estáveis e não estáveis",
    "exemplos simples de backtracking",
    "uso de memoização para otimização",
    "conceito básico de grafo conexo",
    "noções básicas sobre ciclos em grafos",
    "introdução a algoritmos gulosos",
    "diferença entre programação dinâmica e gulosos",
    "uso básico de tabelas hash",
    "construção simples de funções hash",
    "alocação dinâmica de memória básica",
    "conceito de recursão direta",
    "diferença entre tempo de execução no melhor e pior caso",
    "uso de variáveis globais e locais",
    "conversão simples entre estruturas de dados",
    "uso de listas para representar grafos",
    "exemplos simples de algoritmos de busca",
    "uso de árvores para expressar hierarquias",
    "noções básicas de complexidade algorítmica",
    "comparação simples entre algoritmos de ordenação",
    "implementação básica de estrutura de dados stack",
    "implementação básica de estrutura de dados queue",
    "noções básicas de algoritmo de busca em profundidade",
    "noções básicas de algoritmo de busca em largura",
    "aplicações básicas de grafos em redes",
    "uso de vetores para armazenamento de dados",
    "noções de estrutura modular em programação",
